...
| R6 | Chat-Konversationen nicht persistent | Mittel | Mittel | Offen | In-Memory-only; bei Plugin-Neustart verloren |
...
| TS8 | Chat-Konversationen nicht persistent | Mittel | Offen | Konversationen gehen bei Plugin-Neustart verloren |
